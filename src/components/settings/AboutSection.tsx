  ...
  return (
    <>
      <SettingsPage title={en ? 'About Xiangzi MD' : '关于 Xiangzi MD'}>
        ...
        <p className="about-copyright">© {new Date().getFullYear()} guoxiangzi · GNU GPL v3</p>
      </SettingsPage>
        ...
        >
          ...
          >
            ...
            <div className="license-content">
              ...
              <p>
                {en
                  ? 'You may use, study, modify, and distribute this software under GPL v3. Distributed derivative works must remain under GPL v3 and include the corresponding source code.'
                  : '你可以依据 GPL v3 使用、研究、修改和分发本软件；分发衍生作品时须继续采用 GPL v3，并提供相应源代码。'}
              </p>
