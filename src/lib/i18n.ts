...
const EN: Record<string, string> = {
  ...
  切换到此工作区: 'Switch workspace to this folder',
  文件夹: 'Folders',
  文档: 'Files',
  ...
  侧边栏宽度: 'Sidebar width',
  结果列宽度: 'Results pane width',
  大纲宽度: 'Outline width',
  双击恢复默认宽度: 'double-click to reset',
  文件树排序: 'File tree sort',
  '名称（A→Z）': 'Name (A→Z)',
  '名称（Z→A）': 'Name (Z→A)',
  ...
  新建文件: 'New File',
  打开文件: 'Open File',
  检测到可打开的文件: 'Openable file detected',
  检测到可打开的文件夹: 'Openable folder detected',
  检测到可打开路径: 'Openable path detected',
  '剪切板中有一个可打开的路径，是否要打开？': 'An openable path is in the clipboard. Open it?',
  最近文件: 'Recent Files',
  最近文件夹: 'Recent Folders',
  最近打开的文件: 'Recently opened files',
  最近打开的文件夹: 'Recently opened folders',
  暂无最近打开的文件: 'No recently opened files',
  暂无最近打开的文件夹: 'No recently opened folders',
  恢复草稿: 'Recover Drafts',
  恢复: 'Recover',
  ...
  左移列: 'Move column left',
  右移列: 'Move column right',
  删列: 'Delete',
  删除当前行: 'Delete row',
  删除当前列: 'Delete column',
  左对齐: 'Align left',
  ...
  '正在准备长图…': 'Preparing long image…',
  '正在渲染并传输长图…': 'Rendering and transferring long image…',
  '正在编码图片…': 'Encoding image…',
  '正在取消导出…': 'Cancelling export…',
  取消导出: 'Cancel export',
  预计还需约: 'About',
  秒: 'seconds remaining',
  分钟: 'minutes remaining',
  小时: 'hours',
  '文件已保存到：': 'Saved to:',
  ...
  适合窗口: 'Fit to window',
  窗口工具: 'Window tools',
  最大化预览窗口: 'Maximize preview',
  还原预览窗口: 'Restore preview',
  系统全屏: 'System full screen',
  退出系统全屏: 'Exit system full screen',
