...
export function createBrowserPreviewSettings(): AppSettings {
  return {
    ...
    showSidebarUndoButton: true,
    showSidebarFavoriteButton: true,
    showSidebarRefreshButton: true,
    showSidebarSearchButton: true,
    showSidebarTagsButton: true,
    showSidebarSortButton: false,
