...
图 10-2：编辑器设置页面。当前版本可直接看到显示标题层级编号、自动保存、代码块自动换行、顶部工具栏、表格列宽布局、编辑时自动调整表格和选中文本快捷工具栏等开关或选项。

| 设置项                     | 默认值   | 可选值                               | 用途与案例                                                                        |
| -------------------------- | -------- | ------------------------------------ | --------------------------------------------------------------------------------- |
| 显示标题层级编号           | 关闭     | 开/关                                | 在编辑器及 HTML/PDF/图片导出中显示 1、1.1、1.1.1，不修改 Markdown 源文档。        |
...
| Word 标题编号   | 关闭         | 导出 Word 时给章节编号。正式报告建议开启。                       |
