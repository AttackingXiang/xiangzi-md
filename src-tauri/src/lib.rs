...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::search_focus_effects::install_search_focus_effect_from_url,
            commands::search_focus_effects::list_installed_search_focus_effects,
            commands::search_focus_effects::remove_installed_search_focus_effect,
