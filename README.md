...
Xiangzi MD is licensed under the [GNU General Public License v3.0](LICENSE). If it removes a little friction from your documentation workflow, consider giving the project a Star so more people can discover it.
